...
class BladeConfig:
    ...
    def __init__(self):
        ...
        self.thickness = 0.23  # current thickness (e/h)
        self.length = 105.25 # current length (L)
        self.width = 52.4  # current width
...
def getMetafor(d={}):
    ...
    if not p['postpro']:
        ...
        # --- Von Mises stress ---
        hcurves.add(24, IFNodalValueExtractor(interactionset(1), IF_EVMS), MeanOperator(),
                    'mean_VonMises_blade')

        # ========================== STRESS ANALYSIS ==========================

        # --- Stress components (Cartesian) ---
        hcurves.add(25, IFNodalValueExtractor(interactionset(1), IF_SIG_XX), MaxOperator(),
                    'max_stress_xx_blade')
        hcurves.add(26, IFNodalValueExtractor(interactionset(1), IF_SIG_YY), MaxOperator(),
                    'max_stress_yy_blade')
        hcurves.add(27, IFNodalValueExtractor(interactionset(1), IF_SIG_XY), MaxOperator(),
                    'max_stress_xy_blade')
        ...
        hcurves.add(31, IFNodalValueExtractor(interactionset(1), IF_P), MaxOperator(),
                    'max_pressure_blade')
        hcurves.add(32, IFNodalValueExtractor(interactionset(1), IF_P), MeanOperator(),
                    'mean_pressure_blade')

        # --- Stress triaxiality ---
        hcurves.add(33, IFNodalValueExtractor(interactionset(1), IF_TRIAX), MaxOperator(),
                    'max_triaxiality_blade')
        hcurves.add(34, IFNodalValueExtractor(interactionset(1), IF_TRIAX), MeanOperator(),
                    'mean_triaxiality_blade')

        # THERMAL EXTRACTORS - Only when thermal is enabled
        if sim_config.enable_thermal:
    ...
    if not p['postpro']:
        try:
            ...
            # Plot 2: Plasticity evolution (disponible avec ou sans thermique)
            plot2 = DataCurveSet()
            plot2.add(VectorDataCurve(15, hcurves.getDataVector(1), hcurves.getDataVector(15), 'Max Plastic Strain'))
            plot2.add(VectorDataCurve(16, hcurves.getDataVector(1), hcurves.getDataVector(16), 'Mean Plastic Strain'))
            plot2.add(
            ...
            # Plot 3: Stress vs Yield comparison (disponible avec ou sans thermique)
            plot3 = DataCurveSet()
            ...
            plot3.add(VectorDataCurve(21, hcurves.getDataVector(1), hcurves.getDataVector(21), 'Mean Yield Function'))

            # Add reference line data for elastic limit visualization
            ...
            # Plot 4: Stress components evolution (disponible avec ou sans thermique)
            plot4 = DataCurveSet()
            ...
            plot4.add(VectorDataCurve(28, hcurves.getDataVector(1), hcurves.getDataVector(28), 'Max σ_1 (Principal)'))
            ...
            # Plot 5: Pressure evolution (separated from triaxiality)
            plot5 = DataCurveSet()
            ...
            # Plot 6: Triaxiality evolution (separated from pressure)
            plot6 = DataCurveSet()
            ...
            # Plot 7: Plasticity onset detection (disponible avec ou sans thermique)
            plot7 = DataCurveSet()
            plot7.add(VectorDataCurve(20, hcurves.getDataVector(1), hcurves.getDataVector(20), 'Max Yield Function'))
            plot7.add(VectorDataCurve(21, hcurves.getDataVector(1), hcurves.getDataVector(21), 'Mean Yield Function'))
            plot7.add(
                VectorDataCurve(19, hcurves.getDataVector(1), hcurves.getDataVector(19), 'Mean Plastic Strain Rate'))
            ...
            if sim_config.enable_thermal:
                ...
                win8 = VizWin()
                win8.add(plot8)
                win8.setPlotTitle("Temperature Evolution - Be-Cu Blade (10C -> 50C)")
                win8.setPlotXLabel("Time [s]")
                win8.setPlotYLabel("Temperature [K]")
                metafor.addObserver(win8)

                # Plot 9: Thermal effects on displacement
                plot9 = DataCurveSet()
                plot9.add(
                ...
                # Plot 11: Rod End Displacement vs Temperature
                plot11 = DataCurveSet()
                plot11.add(
                ...
                # Plot 12: Thermomechanical coupling analysis
                plot12 = DataCurveSet()
                plot12.add(VectorDataCurve(15, hcurves.getDataVector(35), hcurves.getDataVector(15),
                                           'Max Plastic Strain vs Temperature'))
                plot12.add(
                    VectorDataCurve(9, hcurves.getDataVector(35), hcurves.getDataVector(9), 'Von Mises vs Temperature'))
                ...
                # Plot 13: Blade tip displacements vs temperature
                plot13 = DataCurveSet()
