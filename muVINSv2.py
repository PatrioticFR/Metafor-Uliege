...
def getMetafor(d={}):
    ...
    p33 = pointset.define(33, enc - 0.1, L - e - 0.1)  # Point haut droit lame Invar
    p34 = pointset.define(34, enc - e - 0.1, L - e - 0.1)  # Point haut gauche lame Invar
    ...
    # Maillage des nouvelles courbes
    ...
    prp5.put(THICKNESS, 45.0)   # Même épaisseur que la lame Be-Cu
