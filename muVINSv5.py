...
def getMetafor(d={}):
    ...
    p31 = pointset.define(31, enc - ei - 0.1, H / 2)      # Point bas gauche lame Invar
    p32 = pointset.define(32, enc - 0.1, H / 2)  # Point bas droit lame Invar
    p33 = pointset.define(33, enc - 0.1, Li)  # Point haut droit lame Invar
    p34 = pointset.define(34, enc - ei - 0.1, Li)  # Point haut gauche lame Invar
    ...
    # Rotation axis for the clamping (common to both blades)
    ...
    # Apply rotation to INVAR blade (independently centered)
