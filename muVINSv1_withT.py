...
def getMetafor(d={}):
    ...
    # ----------------------------------Temperature change--------------------------------------
    fct_Temp = metafor.getFunctionManager().create(1)
    fct_Temp.setPiecewiseLinear([
        (0.0, 10.0),
        (12.0, 10.0),
        (20.0, 50.0),
        (30.0, 50.0)
    ...
    if not p['postpro']:
        try:
            plot1 = DataCurveSet()
            plot1.add(VectorDataCurve(2, hcurves.getDataVector(1), hcurves.getDataVector(3), 'Rod end Y'))
            plot1.add(VectorDataCurve(10, hcurves.getDataVector(1), hcurves.getDataVector(10), 'P10 Y'))
            plot1.add(VectorDataCurve(11, hcurves.getDataVector(1), hcurves.getDataVector(11), 'P11 Y'))
